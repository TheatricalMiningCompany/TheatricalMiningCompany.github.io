// <script type="text/javascript" src="js/mailpage-tmc.js"></script>
...
function doMailpage(strTo,strSubject,btnName)
  ...
  var urlMail = '@originalplays.com';
  var subMail = '?subject=' +strSubject +'"';
  var postMail = ' onblur=window.close()>Click here to start mail to ' +strTo +'</a>';
  var theMail =  preMail +'theatricalminingcompany@yahoo.com' +subMail +postMail;
